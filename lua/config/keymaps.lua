...
function M.setup()
	...
	keymapper.map("n", "<S-LEFT><S-LEFT>", function()
		vim.cmd.wincmd("h")
	end, "Swap to left window split")
	keymapper.map("n", "<S-RIGHT><S-RIGHT>", function()
		vim.cmd.wincmd("l")
	end)
	keymapper.map("n", "<S-UP><S-UP>", function()
		vim.cmd.wincmd("k")
	end)
	keymapper.map("n", "<S-DOWN><S-DOWN>", function()
		vim.cmd.wincmd("j")
	end)
